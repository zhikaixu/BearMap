...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private static final Set<String> ALLOWED_HIGHWAY_TYPES = new HashSet<>(Arrays.asList("motorway", "trunk", "primary",
            "secondary", "tertiary", "unclassified", "residential", "living_street", "motorway_link", "trunk_link",
...
//            System.out.println("Id of a node in this way: " + attributes.getValue("ref"));
            ...
            lastNodeID = nd;
            g.addConnectedNodeToBackup(lastWayID, lastNodeID);
...
//                System.out.println("Max Speed: " + v);
                ...
                g.addMaxSpeed(lastWayID, v);

            } else if (k.equals("highway")) {
                //System.out.println("Highway type: " + v);
                /* TODO Figure out whether this way and its connections are valid. */
                /* Hint: Setting a "flag" is good enough! */
                g.setFlag(lastWayID, ALLOWED_HIGHWAY_TYPES.contains(v));
            } else if (k.equals("name")) {
//                System.out.println("Way Name: " + v);
                g.setWayName(lastWayID, attributes.getValue("v"));
            }
...
//            System.out.println("Finishing a way...");
            if (g.isValidWay(lastWayID)) {
                g.addConnectedWayToNode(lastWayID);
            }
        }
    }
